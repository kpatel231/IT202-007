  ...
  -  List of Evidence of Feature Completion
    ...
    - Screenshots
      - Screenshot #15 (paste the image so it uploads to github) (repeat as necessary)
        ...
        - Screenshot #15 Succesfully logout from homepage
- [x] (11/11/2021 of completion) Basic security rules implemented (from the proposal bullet point, if it's a sub-point indent it properly)
  -  List of Evidence of Feature Completion
    ...
    - Pull Requests
      - https://github.com/kpatel231/IT202-007/pull/22
      - Screenshot #16 (paste the image so it uploads to github) (repeat as necessary)
        ...
        - Screenshot #17 Showing the code for if the users is logged in
      Screenshot #18
        ...
        Screenshot #18 User must be logged in to view page
      Screenshot #19
  ...
  -  List of Evidence of Feature Completion
    ...
    - Pull Requests
      ...
      Screenshot #22
        ...
        Screenshot #22 Users has admin permission
- [x] (11/11/2021 of completion) Site should have basic styles/theme applied; everything should be styled (from the proposal bullet point, if it's a sub-point indent it properly)
  -  List of Evidence of Feature Completion
    ...
    - Screenshots #23
      ...
      Screenshot #23 code for using bootstrap style
  ...
  -  List of Evidence of Feature Completion
    ...
    - Pull Requests
      ...
      - Screenshot #25 (paste the image so it uploads to github) (repeat as necessary)
        ...
        - Screenshot #25 showing the users profile
